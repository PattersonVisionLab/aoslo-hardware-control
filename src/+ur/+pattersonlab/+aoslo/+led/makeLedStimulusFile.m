function X = makeLEDStimulusFile(fName, X, ledObj)
    ...
    fprintf(fid, 'lut1 		= C:\\Users\\slo\\Desktop\\Testing Files\\LinearLUT.txt\r\n');
    fprintf(fid, 'lut2 		= C:\\Users\\slo\\Desktop\\Testing Files\\LinearLUT.txt\r\n');
    fprintf(fid, 'lut3 		= C:\\Users\\slo\\Desktop\\Testing Files\\LinearLUT.txt\r\n');
