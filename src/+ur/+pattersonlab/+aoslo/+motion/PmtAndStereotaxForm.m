classdef PmtAndStereotaxForm < ur.pattersonlab.aoslo.motion.KinesisControllerForm
    ...
    methods
        function obj = PmtAndStereotaxForm(deviceManager)
            arguments 
                deviceManager = []
            end
    ...
    methods (Access = protected)
        ...
        function createForm(obj)
            ...
            channelNames = ["Reflectance", "Fluorescence", "Stereotax"];
